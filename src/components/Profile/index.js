...
function Profile() {
  ...
  return (
    <div className={moreInfoShow ? 'card p-2 ms-3 w-100 animated animatedFadeInUp fadeInUp' : "card ms-3 w-100 animated animatedFadeInDown fadeInDown"}>{
      moreInfoShow !== true ? <div>
